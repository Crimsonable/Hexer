...
void Shader::setVec2(const std::string &name,
                     const Expblas::vec2f &value) const {
  glUniform2fv(glGetUniformLocation(ID, name.c_str()), 1, value.dataptr());
}
...
void Shader::setVec3(const std::string &name,
                     const Expblas::vec3f &value) const {
  glUniform3fv(glGetUniformLocation(ID, name.c_str()), 1, value.dataptr());
}
...
void Shader::setMat2(const std::string &name, const Expblas::mat2f &mat) const {
  glUniformMatrix2fv(glGetUniformLocation(ID, name.c_str()), 1, GL_FALSE,
                     mat.dataptr());
}

void Shader::setMat3(const std::string &name, const Expblas::mat3f &mat) const {
